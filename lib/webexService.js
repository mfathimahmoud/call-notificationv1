...
export function getAuthorizationUrl(state) {
  let redirectUri = `https://webexapis.com/v1/authorize?client_id=${config.webex.clientId}&response_type=code`;
  redirectUri += `&redirect_uri=${encodeURIComponent(config.webex.baseUri)}%2Foauth&scope=${config.webex.scopes}`;
